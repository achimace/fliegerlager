...
// Force all PHP errors to be displayed for debugging
...
// Get Participants and Aircraft, sorted by ID
...
<body class="app-body">
    ...
    <div class="app-container">
        ...
        <p>Erfassen Sie hier die finalen Anwesenheitsdaten. Klicken Sie auf '+ Hinzufügen', um neue Zeilen zu erstellen, und speichern Sie alle Änderungen am Ende mit dem Haupt-Button.</p>
        ...
        <form action="handle_final_billing.php" method="post">
            ...
            <div class="section">
                <div class="section-header">
                    <h3>Teilnehmer</h3>
                    <button type="button" onclick="addNewRow('participant-table-body', 'participant-template-row')" class="btn">+ Teilnehmer hinzufügen</button>
                </div>
                <div style="overflow-x: auto;">
                    <table class="styled-table">
                        <thead>
                            <tr><th>Name</th><th>Rolle</th><th style="text-align: center;">Hat teilgenommen</th><th>Anreise</th><th>Abreise</th><th>Nächte Camping</th></tr>
                        </thead>
                        <tbody id="participant-table-body">
                            <?php 
                            $rollen = ['Pilot', 'Flugschüler', 'Begleitperson'];
                            foreach ($teilnehmer as $person): 
                            ?>
                            <tr>
                                <td><?php echo htmlspecialchars($person['vorname'] . ' ' . $person['nachname']); ?></td>
                                <td>
                                    <select name="teilnehmer[<?php echo $person['id']; ?>][rolle]">
                        ...
                        <tfoot style="display: none;">
                            <tr id="participant-template-row">
                                <td><input type="text" name="new_teilnehmer_name[]" placeholder="Vorname Nachname"></td>
                                <td>
                                    <select name="new_teilnehmer_rolle[]">
                                        <option value="Pilot">Pilot</option>
                                        <option value="Flugschüler">Flugschüler</option>
                                        <option value="Begleitperson">Begleitperson</option>
                                    </select>
                                </td>
                                <td style="text-align: center;"><input type="checkbox" name="new_teilnehmer_teilnahme[]" value="1" checked></td>
            ...
            <div class="section">
                <div class="section-header">
                    <h3>Flugzeuge</h3>
                    <button type="button" onclick="addNewRow('aircraft-table-body', 'aircraft-template-row')" class="btn">+ Flugzeug hinzufügen</button>
                </div>
                <div style="overflow-x: auto;">
                    <table class="styled-table">
                        ...
                        <tfoot style="display: none;">
                            <tr id="aircraft-template-row">
                                <td><input type="text" name="new_flugzeug_kennzeichen[]" placeholder="Kennzeichen"></td>
                                <td style="text-align: center;"><input type="checkbox" name="new_flugzeug_teilnahme[]" value="1" checked></td>
            ...
            <div class="section">
                <button type="submit" name="action" value="save_and_summarize" class="btn btn-primary">Alle Daten speichern & Zusammenfassung anzeigen</button>
            </div>
        </form>
        <div class="section">
...
<script>
    function addNewRow(tbodyId, templateId) {
