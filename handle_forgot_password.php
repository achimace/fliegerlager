...
// We don't need date_default_timezone_set() when using the DateTime object method below.
...
<body class="login-body">
    <div class="login-container">
        ...
        <?php if ($message) echo '<div class="login-message success">' . htmlspecialchars($message) . '</div>'; ?>
        <?php if ($error) echo '<div class="login-message error">' . htmlspecialchars($error) . '</div>'; ?>
